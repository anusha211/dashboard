...
export class ChartSection extends Component {
            ...
            ,Market_Cap: {
                options: {
                    grid: {
                        ...
                        labels: {
                          style: {
                          colors: '#ffffff', // Change this to the desired color
                          }
                      }
                    },dataLabels: {
                        enabled: false
    ...
    fetchData = async () => {
        ...
        this.setState({ Tot_Vol: { options: this.state.Tot_Vol.options, series: [{ name: 'Market Volume', data: jsonChartData.total_volumes }] } })
